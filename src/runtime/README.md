...
Starter hydration applies only to a root from tier 3. A root named by flag or
environment is never scaffolded; when it does not exist, that is a fault rather
than a reason to create one.
