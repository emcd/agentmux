...
fn print_agentmux_help() {
    println!(concat!(
        ...
        "  up (<bundle-id> | --group GROUP) [--configuration-directory PATH] ",
        "[--state-directory PATH] [--inscriptions-directory PATH|",
        "--logs-directory PATH]\n",
        "  down (<bundle-id> | --group GROUP) [--configuration-directory PATH] ",
        "[--state-directory PATH] [--inscriptions-directory PATH|",
        "--logs-directory PATH]\n",
        ...
        "[--as-session NAME] [--json] [--configuration-directory PATH] ",
        "[--state-directory PATH] [--inscriptions-directory PATH|",
        "--logs-directory PATH]\n",
        ...
        "                 State root. Also settable as AGENTMUX_STATE_DIRECTORY, which the\n",
        "                 flag outranks. One state root is one relay: isolate a deployment\n",
        "                 by naming a distinct root.\n",
