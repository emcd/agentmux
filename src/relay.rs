...
use self::tmux::{
    capture_pane_snapshot, capture_pane_tail_lines, emit_delivery_diagnostic, inject_prompt,
    operator_interaction_active, resolve_active_pane_target, resolve_cursor_column,
    resolve_window_activity_marker, run_tmux_command, run_tmux_command_capture,
