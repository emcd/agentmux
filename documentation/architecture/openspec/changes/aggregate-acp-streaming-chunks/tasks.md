...
- [ ] 1.2 Helper scope: same-kind User, Agent, Cognition, Update with
...
- [ ] 1.3 Add a non-coalescing prompt-path helper
...
- [ ] 2.6 `tests/unit/acp/replay_coalescence.rs`: non-coalescing prompt-
...
- [ ] 2.7 `tests/unit/acp/replay_coalescence.rs`: session/load replay-
