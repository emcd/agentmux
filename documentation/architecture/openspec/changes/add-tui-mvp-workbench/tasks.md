...
- [ ] 1.4 Lock async-only delivery behavior in TUI MVP:
      - no delivery-mode toggle
      - events overlay shortcut behavior
      - pending indicator contract
- [ ] 1.5 Lock target identifier grammar and MVP validation semantics:
...
- [ ] 1.6 Map each TUI interaction to existing relay contracts and error codes
